...
public class BuildingTask implements Runnable{
    ...
    public BuildingTask(final StatueGenerator plugin, final String senderName, final Location playerLocation, final Direction dir, final String playerid){
        this.plugin = plugin;
    ...
    public void run(){
        ...
        // 使用場所からある程度離れた場所を生成の基点とする
        if (face == 0) tmpLoc = loc.add(0, 0, 3);
        else if (face == 1) tmpLoc = loc.add(-3, 0, 0);
        else if (face == 2) tmpLoc = loc.add(0, 0, -3);
        else if (face == 3) tmpLoc = loc.add(3, 0, 0);
        ...
        for (int x = 40; x <= 47; x++){
        	for (int y = 0; y <= 7; y++){
                ...
                tmpLoc.clone().add(ax, ay, az).getBlock().setTypeIdAndData(putData.getID(), putData.getData(), true);
        	}
        }
        // 顔 下 up
        tmpface = face;
        for (int x = 16; x <= 23; x++){
        	for (int y = 0; y <= 7; y++){
                ...
                // 内部の湧き潰し
                if ((x == 17 || x == 22) && y == 1) tmpLoc.clone().add(ax, ay + 1, az).getBlock().setTypeIdAndData(Material.GLOWSTONE.getId(), (byte) 0, true);
                putData = blocks[x][y];
                if (putData.getID() == Material.AIR.getId()) continue;
                tmpLoc.clone().add(ax, ay, az).getBlock().setTypeIdAndData(putData.getID(), putData.getData(), true);
        	}
        ...
        for (int x = 28; x <= 35; x++){
        	for (int y = 16; y <= 19; y++){
        		if (tmpface == 0) ax = -(x - 28);
                else if (tmpface == 1) az = -(x - 28);
                else if (tmpface == 2) ax = x - 28;
                else if (tmpface == 3) az = x - 28;
                ...
                // 内部の湧き潰し
                if ((x == 29 || x == 34) && y == 17) tmpLoc.clone().add(ax, ay + 1, az).getBlock().setTypeIdAndData(Material.GLOWSTONE.getId(), (byte) 0, true);
                putData = blocks[x][y];
                if (putData.getID() == Material.AIR.getId()) continue;
                tmpLoc.clone().add(ax, ay, az).getBlock().setTypeIdAndData(putData.getID(), putData.getData(), true);
        	}
        ...
        for (int x = 20; x <= 27; x++){
        	for (int y = 16; y <= 19; y++){
        		if (tmpface == 0) ax = -(x - 20);
                else if (tmpface == 1) az = -(x - 20);
                else if (tmpface == 2) ax = x - 20;
                else if (tmpface == 3) az = x - 20;
        ...
        for (int x = 48; x <= 51; x++){
        	for (int y = 16; y <= 19; y++){
                ...
                bx = ax;
                bz = az;
                if (tmpface == 0) bx -= 15 - ((x - 48) * 2);
                else if (tmpface == 1) bz -= 15 - ((x - 48) * 2);
                else if (tmpface == 2) bx += 15 - ((x - 48) * 2);
                else if (tmpface == 3) bz += 15 - ((x - 48) * 2);

                // 内部の湧き潰し
                if (x == 49 && y == 17) {
                	tmpLoc.clone().add(ax, ay + 1, az).getBlock().setTypeIdAndData(Material.GLOWSTONE.getId(), (byte) 0, true);
                	tmpLoc.clone().add(bx, ay + 1, bz).getBlock().setTypeIdAndData(Material.GLOWSTONE.getId(), (byte) 0, true);
                }
                putData = blocks[x][y];
                if (putData.getID() == Material.AIR.getId()) continue;
                tmpLoc.clone().add(ax, ay, az).getBlock().setTypeIdAndData(putData.getID(), putData.getData(), true);
                tmpLoc.clone().add(bx, ay, bz).getBlock().setTypeIdAndData(putData.getID(), putData.getData(), true);
        	}
        }
        // 腕 上 up
        tmpface = face;
        for (int x = 44; x <= 47; x++){
        	for (int y = 16; y <= 19; y++){
                ...
                bx = ax;
                bz = az;
                if (tmpface == 0) bx -= 15 - ((x - 44) * 2);
                else if (tmpface == 1) bz -= 15 - ((x - 44) * 2);
                else if (tmpface == 2) bx += 15 - ((x - 44) * 2);
                else if (tmpface == 3) bz += 15 - ((x - 44) * 2);
        ...
        for (int x = 52; x <= 55; x++){
        	for (int y = 20; y <= 31; y++){
                ...
                bx = ax;
                bz = az;
                if (tmpface == 0) bx += 9 + ((x - 52) * 2);
                else if (tmpface == 1) bz += 9 + ((x - 52) * 2);
                else if (tmpface == 2) bx -= 9 + ((x - 52) * 2);
                else if (tmpface == 3) bz -= 9 + ((x - 52) * 2);
        ...
        for (int x = 8; x <= 11; x++){
        	for (int y = 16; y <= 19; y++){
                ...
                bx = ax;
                bz = az;
                if (tmpface == 0) bx -= 7 - ((x - 8) * 2);
                else if (tmpface == 1) bz -= 7 - ((x - 8) * 2);
                else if (tmpface == 2) bx += 7 - ((x - 8) * 2);
                else if (tmpface == 3) bz += 7 - ((x - 8) * 2);
        ...
        for (int x = 4; x <= 7; x++){
        	for (int y = 16; y <= 19; y++){
                ...
                bx = ax;
                bz = az;
                if (tmpface == 0) bx -= 7 - ((x - 4) * 2);
                else if (tmpface == 1) bz -= 7 - ((x - 4) * 2);
                else if (tmpface == 2) bx += 7 - ((x - 4) * 2);
                else if (tmpface == 3) bz += 7 - ((x - 4) * 2);
        ...
        for (int x = 12; x <= 15; x++){
        	for (int y = 20; y <= 31; y++){
                ...
                bx = ax;
                bz = az;
                if (tmpface == 0) bx += 1 + ((x - 12) * 2);
                else if (tmpface == 1) bz += 1 + ((x - 12) * 2);
                else if (tmpface == 2) bx -= 1 + ((x - 12) * 2);
                else if (tmpface == 3) bz -= 1 + ((x - 12) * 2);
        ...
        sendMessage("&aGenerated "+ playerid +"'s statue!");
