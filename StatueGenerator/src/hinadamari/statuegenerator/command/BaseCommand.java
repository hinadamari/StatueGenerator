...
import hinadamari.statuegenerator.ConfigurationManager;
...
public abstract class BaseCommand {
    // Logger
    protected static final Logger log = StatueGenerator.log;
    protected static final String logPrefix = StatueGenerator.logPrefix;
    protected static final String msgPrefix = StatueGenerator.msgPrefix;
    /* コマンド関係 */
    ...
    protected StatueGenerator plugin;
    protected ConfigurationManager config;

    public boolean run(final StatueGenerator plugin, final CommandSender sender, final String[] preArgs, final String cmd) {
        this.plugin = plugin;
